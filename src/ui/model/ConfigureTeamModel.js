...
export default function ConfigureTeamModel({ modals, toggle, team, handleRemove, getTeamHandler, modalHandler, modal,searchTerm,handleSearch,handleCheckboxChange,selectedTeams,selectedTeamHandler,selectedTeamsArr,restoreHandler,addOneTeamHandler,configureTeamHandler}) {
      ...
      <Modal isOpen={modals} toggle={toggle} size='xl' fullscreen='true' >
        ...
        <ModalBody>
          <div className='d-flex'>
            ...
            <div className='flex-grow-1 border'>
              <SelectedBufferTeam selectedTeamsArr={selectedTeamsArr} restoreHandler={restoreHandler}/>
            </div>
          </div>
